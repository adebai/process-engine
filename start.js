...
cmd.command("generate-json <source> [destination] <extension>")
    ...
    " Supported extension: .json, .hex and .bin. Note that .bin might not generate an actual binary data. Check https://developer.mozilla.org/en-US/docs/Web/API/DOMString/Binary" +
