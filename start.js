...
cmd.command("generate-json <source> [destination] <extension>")
    .description("Generates a compact JSON version of your input javascript \nfile."+ 
    "The JSON file can be distributed easily since it is smaller in size" + 
    "\n Supported extension: .json, .hex and .bin. \nNote that .bin might not generate an actual binary data.\n Check https://developer.mozilla.org/en-US/docs/Web/API/DOMString/Binary" +
    "for more info. \nSupport for more extensions will be added later.")
